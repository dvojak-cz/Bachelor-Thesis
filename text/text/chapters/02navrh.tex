...
\uv{I don’t think it’s a stretch to suggest that you are never, ever going to need to do this.}\\(Nemyslím si, že by bylo přitažené za vlasy naznačovat, že to nikdy, nikdy nebudete muset udělat.)
\end{displayquote}
...
V dřívějších verzích Kubernetes bylo možné definovat cestu k adresáři s konfigurací pomocí \verb|--cni-conf-dir|, tento flag byl ve verzi \verb|1.24| odstraněn. \cite{k8scirobot_2020_merge} 
